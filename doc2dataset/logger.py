        ...
        print(
            " - ".join(
                [
                    ...
                    f"failed to extract: {failed_to_resize_ratio:.3f}",
                    f"docs per sec: {img_per_sec:.0f}",
                    f"count: {count}",
                ]
            )
        )
